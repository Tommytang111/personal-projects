...
## Description
This repository contains Python scripts for small projects mostly related to machine learning. Each project is organized by its own folder.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/tommytang111/personal-projects.git
   ```
...
## Content
Each folder contains a project, which will include any relevant datasets and scripts.
